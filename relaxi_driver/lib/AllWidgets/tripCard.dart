                                ...
                                child: Row(
                                  ...
                                  children: [
                                    ...
                                    Expanded(
                                      child: Column(
                                        children: [
                                          Text('earnings', style: GoogleFonts.ubuntuCondensed(color: grey),),
                                    ...
                                    Expanded(
                                      child: Column(
                                        ...
                                        children: [
                                          Text('Customer', style: GoogleFonts.ubuntuCondensed(color: grey),),
                                          Text(widget.trip!.rider_name.toString() ,textAlign: TextAlign.center,style: TextStyle(color: Colors.black,fontSize: 12.0),),
                                        ],
                                      ),
                                    )
                                  ],
